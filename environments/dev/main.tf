module "backend" {
  source                = "git::https://github.com/image-processor-demo/modules.git//backend?ref=v0.3.13"
...
module "frontend" {
  source                  = "git::https://github.com/image-processor-demo/modules.git//frontend?ref=v0.3.13"
  environment             = var.environment
  api_shared_secret       = var.api_shared_secret
